            ...
            if (!content.Car.Any())
                content.AddRange
                    ...
                    new Car
                    {
                        ...
                        longDesc = "Красивый, быстрый и очень тихий фвтомобиль компании Tesla",
                        img = "/img/farcry2_header.jpg",
                        price = 45000,
                        isFavourite = true,
                        available = true,
                    ...
                    new Car
                    {
                        ...
                        longDesc = "Удобный автомобиль для городской жизни",
                        img = "/img/borderlands_header.jpg",
                        price = 40000,
                        isFavourite = false,
                        available = false,
                        Category = Categories["Классические автомобили"]
                    ...
                    new Car
                    {
                        ...
                        longDesc = "Удобный автомобиль для городской жизни",
                        img = "/img/Borderlands_2_header.jpg",
                        price = 14000,
                        isFavourite = true,
                        available = true,
                        Category = Categories["Электромобили"]
